...
class League(Base):
    ...
    league_name = Column(String(255), unique=False, nullable=False)
    ...
    league_maps = relationship("LeagueMap")

    def __init__(self, league_name, creator, mod_id, matches_per_ai_pair, 
				 speed, soft_timeout, hard_timeout, sides,
